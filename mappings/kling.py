...
MAPPINGS = {
    ...
    r'^/proxy/kling/v\d+/videos/text2video/([^/]+)$': {
        'provider': 'kling',
        'url_template': 'https://api.klingai.com/v1/videos/text2video/{0}',
        'auth_fn': lambda key: {'Authorization': f'Bearer {key}'},
        'request_transform': None,
        'response_transform': None,
    },
    ...
    r'^/proxy/kling/v\d+/videos/image2video/([^/]+)$': {
        'provider': 'kling',
        'url_template': 'https://api.klingai.com/v1/videos/image2video/{0}',
        'auth_fn': lambda key: {'Authorization': f'Bearer {key}'},
        'request_transform': None,
        'response_transform': None,
    },
    r'^/proxy/kling/v1/videos/motion-control$': {
        'provider': 'kling',
        'url_template': 'https://api.klingai.com/v1/videos/motion-control',
        'auth_fn': lambda key: {'Authorization': f'Bearer {key}'},
        'request_transform': None,
        'response_transform': None,
    },
    r'^/proxy/kling/v1/videos/motion-control/([^/]+)$': {
        'provider': 'kling',
        'url_template': 'https://api.klingai.com/v1/videos/motion-control/{0}',
        'auth_fn': lambda key: {'Authorization': f'Bearer {key}'},
        'request_transform': None,
        'response_transform': None,
    },
    ...
    r'^/proxy/kling/v1/videos/avatar/image2video$': {
        'provider': 'kling',
        'url_template': 'https://api.klingai.com/v1/videos/avatar/image2video',
        'auth_fn': lambda key: {'Authorization': f'Bearer {key}'},
        'request_transform': None,
        'response_transform': None,
    },
    r'^/proxy/kling/v1/videos/avatar/image2video/([^/]+)$': {
        'provider': 'kling',
        'url_template': 'https://api.klingai.com/v1/videos/avatar/image2video/{0}',
        'auth_fn': lambda key: {'Authorization': f'Bearer {key}'},
        'request_transform': None,
        'response_transform': None,
    },
